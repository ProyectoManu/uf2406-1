...
public class Envio {
	...
	@Override
	public int hashCode() {
		return Objects.hash(destinoNacional, origenNacional);
	}
	...
	public boolean equals(Object obj) {
		...
		return destinoNacional == other.destinoNacional && origenNacional == other.origenNacional;
	}
	protected void calcularImporte() {
		int importenacional=4;
		int importe=7;
		
		
		if (importenacional=tipoEnvio(1))
	}
}
